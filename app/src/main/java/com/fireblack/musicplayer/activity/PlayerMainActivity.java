...
public class PlayerMainActivity extends BaseActivity {
    ...
    private FlingGallery fgv_player_main;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fgv_player_main = (FlingGallery) this
    ...
    // 记录FlingGallery上次Touch事件的Position
    private float lastX = 0;
    private float lastY = 0;
    private FlingGallery.OnCustomTouchListener customTouchListener = new FlingGallery.OnCustomTouchListener() {
    ...
    private void setAlbum(int rid){
        ...
        iv_player_ablum_reflection.setImageBitmap(ImageUtils
    ...
    private void setAlbum(Bitmap bitmap){
        ...
        iv_player_ablum_reflection.setImageBitmap(ImageUtils.createReflectionBitmapForSingle(bitmap));
    }
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                ...
                case R.id.ibtn_player_control_menu:
                    new MyDialog.Builder(PlayerMainActivity.this).setTitle(tv_player_song_info.getText()).setMessage("抱歉，暂时没有开发").create().show();
                    break;
                case R.id.ibtn_player_control_mode:
                    ...
                    Toast.makeText(PlayerMainActivity.this,player_modeStr[player_mode],Toast.LENGTH_SHORT).show();
                    break;
                ...
                case R.id.ibtn_player_control_play:
                    if(mediaPlayerManager.getPlayerState()==MediaPlayerManager.STATE_NULL){
                        Toast.makeText(PlayerMainActivity.this,"请先添加歌曲...",Toast.LENGTH_SHORT).show();
                        return;
                    }
                    //顺序列表播放结束
                    if(mediaPlayerManager.getPlayerState()==MediaPlayerManager.STATE_OVER){
                        Toast.makeText(PlayerMainActivity.this,"播放列表已经按顺序播放完毕！",Toast.LENGTH_SHORT).show();
                        return;
                    }

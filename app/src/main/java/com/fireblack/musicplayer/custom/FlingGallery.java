...
/**
 * Created by ChengHao on 2016/5/11.
 */

public class FlingGallery extends ViewGroup {
    ...
    public FlingGallery(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs,
                R.styleable.FlingGallery, defStyle, 0);
        mCurrentScreen = a
                .getInt(R.styleable.FlingGallery_defaultScreen, 0);
        a.recycle();
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_UP:
                if (mTouchState == TOUCH_STATE_SCROLLING) {
                    ...
                    velocityTracker.computeCurrentVelocity(1000, mMaxVelocity);// 使用pix/s为单位

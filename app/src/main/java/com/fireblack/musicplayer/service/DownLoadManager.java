...
public class DownLoadManager {
    ...
    //下载任务-广播动作类型
    public static final String BROADCASTRECEVIER_ACTON="com.fireblack.musicplayer.download.brocast";
    ...
    public static final String SERVICE_ACTION="com.fireblack.musicplayer.service.download";
